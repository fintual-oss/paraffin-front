...
export const LoginDialog = () => {
  ...
  const renderFoter = () => {
    return <Button label="Ingresar" onClick={() => router.push('/users/sign_in')} />;
  };

  return (
    <Dialog visible={loginDialog.displayLoginDialog} className={style.dialog_login} onHide={() => loginDialog.setDisplayLoginDialog(false)} header="¡Únete a ser.dev!" footer={renderFoter()}>
